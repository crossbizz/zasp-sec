...
The current honest result is `UI/API coverage passed: planned=13
api_available=6 available=125 public=131 internal=0.` The gate distinguishes
...
```text
UI/API coverage passed: planned=13 api_available=6 available=125 public=131 internal=0.
```
