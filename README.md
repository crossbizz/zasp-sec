...
api_available=6 available=138 public=144 internal=0.` The gate distinguishes
...
```text
UI/API coverage passed: planned=6 api_available=6 available=138 public=144 internal=0.
```
