...
api_available=6 available=135 public=141 internal=0.` The gate distinguishes
...
```text
UI/API coverage passed: planned=8 api_available=6 available=135 public=141 internal=0.
```
