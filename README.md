...
The current honest result is `UI/API coverage passed: planned=8
api_available=11 available=129 public=140 internal=0.` The gate distinguishes
...
```text
UI/API coverage passed: planned=8 api_available=11 available=129 public=140 internal=0.
```
