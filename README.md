...
The current honest result is `UI/API coverage passed: planned=23
api_available=6 available=113 public=119 internal=0.` The gate distinguishes
...
```text
UI/API coverage passed: planned=23 api_available=6 available=113 public=119 internal=0.
```
