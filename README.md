...
api_available=6 available=137 public=143 internal=0.` The gate distinguishes
...
```text
UI/API coverage passed: planned=6 api_available=6 available=137 public=143 internal=0.
```
