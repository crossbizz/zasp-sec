...
The current honest result is `UI/API coverage passed: planned=6
api_available=6 available=140 public=146 internal=0.` The gate distinguishes
...
```text
UI/API coverage passed: planned=6 api_available=6 available=140 public=146 internal=0.
```
