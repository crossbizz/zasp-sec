...
try {
  ...
  await waitForBrowserScope(browser.cdp, "pid_10000001-0000-4000-8000-000000000001/pid_10000002-0000-4000-8000-000000000002/pid_10000003-0000-4000-8000-000000000003");
  await clickBrowserText(browser.cdp, "Console logins");
...
async function exerciseRuntimeSessionReads(cdp, dsn) {
  ...
  try {
    ...
    await waitForBrowserText(cdp, /No matching runtime sessions/);
    await fillBrowserLabel(cdp, "Process", "/usr/bin/agent");
    await clickBrowserText(cdp, "Search sessions");
