...
test("all five future public operations resolve and deliberate removal fails", async () => {
...
test("API-available operations require OpenAPI but do not claim a wired UI", async () => {
  ...
  assert.deepEqual(result, { planned: 4, apiAvailable: 38, available: 20, public: 58, internal: 0 });
...
test("CLI emits only fixed success or rejection lines", async () => {
  ...
  assert.equal(successOut.value(), "UI/API coverage passed: planned=5 api_available=37 available=20 public=57 internal=0.\n");
