...
test("API-available operations require OpenAPI but do not claim a wired UI", async () => {
  ...
  assert.deepEqual(result, { planned: 12, apiAvailable: 63, available: 55, public: 118, internal: 0 });
...
test("CLI emits only fixed success or rejection lines", async () => {
  ...
  assert.equal(successOut.value(), "UI/API coverage passed: planned=12 api_available=63 available=55 public=118 internal=0.\n");
