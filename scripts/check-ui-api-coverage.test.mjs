...
test("API-available operations require OpenAPI but do not claim a wired UI", async () => {
  ...
  assert.deepEqual(result, { planned: 4, apiAvailable: 25, available: 20, public: 45, internal: 0 });
...
test("CLI emits only fixed success or rejection lines", async () => {
  ...
  assert.equal(successOut.value(), "UI/API coverage passed: planned=5 api_available=24 available=20 public=44 internal=0.\n");
