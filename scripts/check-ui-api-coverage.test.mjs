...
test("API-available operations require OpenAPI but do not claim a wired UI", async () => {
  ...
  assert.deepEqual(result, { planned: 6, apiAvailable: 6, available: 138, public: 144, internal: 0 });
...
test("CLI emits only fixed success or rejection lines", async () => {
  ...
  assert.equal(successOut.value(), "UI/API coverage passed: planned=6 api_available=6 available=138 public=144 internal=0.\n");
