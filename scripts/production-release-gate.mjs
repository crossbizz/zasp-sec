...
for (const moduleRoot of ["services/health", "services/platform", "services/event-ingest", "services/runtime-gateway"]) {
...
console.log("production release gate: source SBOM/license/container/secret + resilience/dependency checks passed");
