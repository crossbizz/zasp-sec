...
const expectedMilestoneClassCounts = new Map([
  ...
  ["M7A", new Map([["production-available", 84], ["component-only", 29], ["blocked/external", 0], ["missing", 0]])],
...
const auditedProductionAvailableIDs = new Set([
  ...
  "M7A-50", "M7A-52", "M7A-53", "M7A-54", "M7A-55", "M7A-56", "M7A-57", "M7A-58", "M7A-59", "M7A-60", "M7A-93", "M7A-97", "M7A-98", "M7A-99",
