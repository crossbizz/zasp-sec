...
const expectedMilestoneClassCounts = new Map([
  ...
  ["M3", new Map([["production-available", 67], ["component-only", 6], ["blocked/external", 2], ["missing", 0]])],
