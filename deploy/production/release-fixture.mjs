...
export const productionReleaseFixture = Object.freeze({
  ...
  recovery: Object.freeze({
    canaryEnabled: true,
    awsRegion: "us-west-2",
    backupQueueURL: "https://sqs.us-west-2.amazonaws.com/123456789012/agentsec-recovery-backup-jobs",
    restoreQueueURL: "https://sqs.us-west-2.amazonaws.com/123456789012/agentsec-recovery-restore-jobs",
    evidenceBucket: "zasp-production-evidence",
    evidenceBucketOwner: "123456789012",
    evidenceKMSKeyArn: "arn:aws:kms:us-west-2:123456789012:key/11111111-1111-4111-8111-111111111111",
    signingKMSKeyArn: "arn:aws:kms:us-west-2:123456789012:key/55555555-5555-4555-8555-555555555555",
    backupOutboxRoleArn: "arn:aws:iam::123456789012:role/zasp-production-recovery-backup-outbox",
    restoreOutboxRoleArn: "arn:aws:iam::123456789012:role/zasp-production-recovery-restore-outbox",
    backupRoleArn: "arn:aws:iam::123456789012:role/zasp-production-recovery-backup",
    restoreRoleArn: "arn:aws:iam::123456789012:role/zasp-production-recovery-restore",
    webIdentityTokenFile: "/var/run/secrets/eks.amazonaws.com/serviceaccount/token",
    neonProjectID: "zasp-production-recovery",
    neonBranchID: "br-production-main",
    neonSecretReference: "ref:neon/project-api-key",
    kubernetesEndpoint: "https://kubernetes.default.svc",
    runnerImage: "123456789012.dkr.ecr.us-west-2.amazonaws.com/zasp/agentsec-worker@sha256:" + "c".repeat(64),
    runnerServiceAccount: "agentsec-recovery-runner",
    egressCIDRs: Object.freeze(["10.74.0.0/28"]),
    neonEgressCIDRs: Object.freeze(["203.0.113.64/28"]),
