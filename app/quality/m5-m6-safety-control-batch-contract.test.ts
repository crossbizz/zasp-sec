...
describe("M5 completion slice and M6 policy foundation", () => {
  ...
  it("records the remaining 44-task M5/M6 slice as local In-progress work", () => {
    const tracker = read("docs/internal/implementation_status_v1.5.md");
    for (const value of ["| Pending | 0 |", "| In progress | 366 |", "| Complete | 359 |", "| Blocked | 3 |", "`0/366/359/3`", "| M5 | 42 | 0 | 8 | 34 | 0 |", "| M6 | 36 | 0 | 36 | 0 | 0 |"]) expect(tracker).toContain(value);
    const active = tracker.match(/## In progress[\s\S]*?## Complete/)?.[0] ?? "";
    for (const task of ["M5-31", "M5-32", "M5-33a", "M5-33b", "M5-33c", "M5-33", "M5-34", "M5-35", "M6-01", "M6-02", "M6-03", "M6-04", "M6-05", "M6-06", "M6-07", "M6-08", "M6-09", "M6-10", "M6-11", "M6-12", "M6-13", "M6-14", "M6-15", "M6-16", "M6-17", "M6-18", "M6-19", "M6-20", "M6-21", "M6-22", "M6-23", "M6-24", "M6-25", "M6-26", "M6-27", "M6-28", "M6-29", "M6-30", "M6-31a", "M6-31b", "M6-31c", "M6-31d", "M6-31e", "M6-31"]) expect(active.match(new RegExp(`^\\| ${task} \\|`, "gm"))).toHaveLength(1);
