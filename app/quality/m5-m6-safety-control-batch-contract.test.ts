...
describe("M5 completion slice and M6 policy foundation", () => {
  ...
  it("records only the remaining 19-task M6 slice as local In-progress work", () => {
    ...
    for (const task of ["M6-18", "M6-19", "M6-20", "M6-21", "M6-22", "M6-23", "M6-24", "M6-25", "M6-26", "M6-27", "M6-28", "M6-29", "M6-30", "M6-31a", "M6-31b", "M6-31c", "M6-31d", "M6-31e", "M6-31"]) expect(active.match(new RegExp(`^\\| ${task} \\|`, "gm"))).toHaveLength(1);
    expect(tracker).toContain("staging remains unresolved");
