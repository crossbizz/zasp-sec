  ...
  screens: [
    ...
    },
    {
      ...
      actions: [
        ...
        { id: "view_security_actions", operation_id: "listSecurityActions", availability: "api_available" },
        ...
        { id: "view_security_agent_runs", operation_id: "listSecurityAgentRuns", availability: "api_available" },
        { id: "view_security_agent_run", operation_id: "getSecurityAgentRun", availability: "api_available" },
        { id: "cancel_security_agent_run", operation_id: "cancelSecurityAgentRun", availability: "api_available" },
        { id: "view_security_agent_approvals", operation_id: "listSecurityAgentApprovals", availability: "api_available" },
        { id: "view_security_agent_approval", operation_id: "getSecurityAgentApproval", availability: "api_available" },
        { id: "decide_security_agent_approval", operation_id: "decideSecurityAgentApproval", availability: "api_available" },
      ],
    },
    {
      id: "compliance",
...
describe("M1-25 UI API map seed", () => {
  ...
  it("accepts only the exact fourteen-screen, 125-action mixed-lifecycle map", async () => {
  ...
  it("rejects hostile YAML and semantic seed mutations", async () => {
    ...
    for (const mutate of [
      ...
      (value: typeof expectedMap) => Object.assign(value.screens[0].actions[0], { availability: "active" }),
			(value: typeof expectedMap) => Object.assign(value.screens[3].actions[0], { operation_id: "getHomeSummary" }),
    ]) {
