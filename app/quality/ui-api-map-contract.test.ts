  ...
  screens: [
    ...
    },
    {
      ...
      actions: [
        ...
        { id: "view_integration_setup_status", operation_id: "getIntegrationSetupStatus", availability: "available" },
        { id: "test_integration_webhook", operation_id: "testIntegrationWebhook", availability: "available" },
        { id: "view_integration_webhook_status", operation_id: "getIntegrationWebhookStatus", availability: "available" },
    ...
    },
    {
      ...
      label: "Red Team",
      actions: [
        { id: "view_tests", operation_id: "listTests", availability: "available" },
        { id: "create_test", operation_id: "createTest", availability: "available" },
        { id: "view_test", operation_id: "getTest", availability: "available" },
        { id: "update_test", operation_id: "updateTest", availability: "available" },
        { id: "run_test", operation_id: "runTest", availability: "available" },
        ...
        { id: "view_attack_lab_runs", operation_id: "listAttackLabRuns", availability: "available" },
        { id: "preflight_attack_lab_run", operation_id: "preflightAttackLabRun", availability: "available" },
        { id: "create_attack_lab_run", operation_id: "createAttackLabRun", availability: "available" },
        { id: "view_attack_lab_run", operation_id: "getAttackLabRun", availability: "available" },
        { id: "cancel_attack_lab_run", operation_id: "cancelAttackLabRun", availability: "available" },
        { id: "rerun_attack_lab_run", operation_id: "rerunAttackLabRun", availability: "available" },
      ],
    },
    {
      id: "policies",
    ...
    },
    {
      ...
      actions: [
        ...
        { id: "view_session_event_evidence", operation_id: "getSessionEvent", availability: "available" },
