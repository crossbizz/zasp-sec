  ...
  screens: [
    ...
    },
    {
      ...
      actions: [
        ...
        { id: "authorize_integration", operation_id: "authorizeIntegration", availability: "planned" },
        ...
        { id: "update_sensor", operation_id: "updateSensor", availability: "planned" },
        { id: "delete_sensor", operation_id: "deleteSensor", availability: "planned" },
        { id: "rotate_sensor_token", operation_id: "rotateSensorToken", availability: "planned" },
        { id: "view_sensor_coverage", operation_id: "getSensorCoverage", availability: "planned" },
      ],
    },
    {
      id: "inventory",
    ...
    },
    {
      ...
      actions: [
        ...
        { id: "simulate_security_agent", operation_id: "simulateSecurityAgent", availability: "planned" },
        { id: "run_security_agent", operation_id: "runSecurityAgent", availability: "planned" },
        { id: "view_security_agent_runs", operation_id: "listSecurityAgentRuns", availability: "planned" },
        { id: "view_security_agent_run", operation_id: "getSecurityAgentRun", availability: "planned" },
        { id: "cancel_security_agent_run", operation_id: "cancelSecurityAgentRun", availability: "planned" },
        { id: "view_security_agent_approvals", operation_id: "listSecurityAgentApprovals", availability: "planned" },
        { id: "view_security_agent_approval", operation_id: "getSecurityAgentApproval", availability: "planned" },
        { id: "decide_security_agent_approval", operation_id: "decideSecurityAgentApproval", availability: "planned" },
      ],
    },
    {
      id: "compliance",
