...
describe("M1-20 AI gateway contract", () => {
  ...
  it("starts only M1-20 and preserves its prerequisite and blockers", async () => {
    ...
    expect(readme).toMatch(/M1-20\s+is\s+In progress/);
    ...
    expect(active.filter(([task]) => task === "M1-20")).toHaveLength(1);
