...
const initialSensors: Sensor[] = [
  { id: "pid_10000001-0000-4000-8000-000000000001", name: "production-us-west", mode: "metadata_only", capabilities: ["file", "network", "process"], created_at: "2026-08-18T09:00:00.000Z", updated_at: "2026-08-18T10:00:00.000Z", last_heartbeat: "2026-08-18T10:00:00.000Z" },
  { id: "pid_10000002-0000-4000-8000-000000000002", name: "legacy-build-nodes", mode: "metadata_only", capabilities: ["process"], created_at: "2026-08-18T08:00:00.000Z", updated_at: "2026-08-18T09:30:00.000Z", last_heartbeat: "2026-08-18T09:30:00.000Z" },
];

const coverage: Record<string, SensorCoverage> = {
  "pid_10000001-0000-4000-8000-000000000001": { sensor_id: "pid_10000001-0000-4000-8000-000000000001", supported: true, status: "supported", kernel: "6.8.0", btf: true, capabilities: ["file", "network", "process"], event_rate: 128, drops: 0, last_heartbeat: "2026-08-18T10:00:00.000Z" },
