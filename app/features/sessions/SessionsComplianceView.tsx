...
export function SessionsComplianceView({ surface }: { surface: Surface }) {
  ...
  return <div className="page"><PageHeader title="Data and retention" description="Environment-scoped collection, retention, and deletion controls." /><Card title="Production defaults"><p><Badge tone="info">Metadata only</Badge></p><p>30 days</p><p>Deletion enabled</p></Card></div>;
}
