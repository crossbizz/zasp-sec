...
export function SecurityAgentsView({ api = defaultSecurityAgentsAPI, initialTab = "agents" }: { api?: SecurityAgentsAPI; initialTab?: SecurityAgentTab }) {
