...
BEGIN
    ...
    IF actual_fingerprint<>'adeb38ce0184bdd83f964f63a4979eb256cc3bce91d7492e5f1082b992a4a0ae' THEN RAISE EXCEPTION USING ERRCODE='55000',MESSAGE='semantic schema drift blocks rollback'; END IF;
END;
$rollback_guard$;
