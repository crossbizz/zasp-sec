...
BEGIN
    ...
    IF actual_fingerprint<>'bd966f5d85716df21f5c246e1508465bfdfadfe6f2dfdcadfcc5fbe4b22cd4e8' THEN RAISE EXCEPTION USING ERRCODE='55000',MESSAGE='semantic schema drift blocks rollback'; END IF;
END;
$rollback_guard$;
