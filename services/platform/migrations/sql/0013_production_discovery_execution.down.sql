DO $rollback_guard$ BEGIN
 IF zasp_execution_live_fingerprint()<>'9711621a82b309a0fa52be33d76f8395e7b5660275f91cbed6c1e7679700b371' OR NOT zasp_execution_security_ready() THEN RAISE EXCEPTION USING ERRCODE='55000',MESSAGE='semantic schema drift blocks rollback';END IF;
END $rollback_guard$;
