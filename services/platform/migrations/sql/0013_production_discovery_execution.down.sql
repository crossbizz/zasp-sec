DO $rollback_guard$ BEGIN
 IF zasp_execution_live_fingerprint()<>'33e80d7cade882b1a76afef07cc192022a39f7a0f6b10b46e56f1765bfcc6cb8' OR NOT zasp_execution_security_ready() THEN RAISE EXCEPTION USING ERRCODE='55000',MESSAGE='semantic schema drift blocks rollback';END IF;
END $rollback_guard$;
