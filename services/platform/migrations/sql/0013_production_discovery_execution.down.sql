DO $rollback_guard$ BEGIN
 IF zasp_execution_live_fingerprint()<>'5f182eb762ba597ada9f95bd4b9047450c3114ddbce2b78fc7a8551c2f35cfe6' OR NOT zasp_execution_security_ready() THEN RAISE EXCEPTION USING ERRCODE='55000',MESSAGE='semantic schema drift blocks rollback';END IF;
END $rollback_guard$;
