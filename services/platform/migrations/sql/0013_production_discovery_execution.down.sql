DO $rollback_guard$ BEGIN
 IF zasp_execution_live_fingerprint()<>'c0005ad2265b99e737731506a69bd904c1ab7937de341af88078ed5d4d474e42' OR NOT zasp_execution_security_ready() THEN RAISE EXCEPTION USING ERRCODE='55000',MESSAGE='semantic schema drift blocks rollback';END IF;
END $rollback_guard$;
