DO $rollback_guard$ BEGIN
 IF zasp_execution_live_fingerprint()<>'78a086078d3b533262665f6d2ffb5c527601a5f7662d7b0873286678640d515d' OR NOT zasp_execution_security_ready() THEN RAISE EXCEPTION USING ERRCODE='55000',MESSAGE='semantic schema drift blocks rollback';END IF;
END $rollback_guard$;
