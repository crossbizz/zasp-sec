DO $release_guard$ BEGIN
  IF NOT zasp_inventory_readiness(
    '5b3f27aa7f315325c64caabee4c2a9e6d43235f4c3136cd2728df35cb4351a13',
    '707a81d31a7dfd00cf7f5c60c081bf4c567054e7cf761b80cb142855adaacabd'
  ) THEN
...
DECLARE authority_value jsonb;organization_value text;workspace_value text;environment_value text;sensor_value text;token_value text;token_generation_value bigint;generation_value bigint;request_digest_value bytea;artifact_key_value text;prior_value zasp_runtime_batch_authorities%ROWTYPE;
BEGIN
...
GRANT EXECUTE ON FUNCTION public.zasp_runtime_issue_sensor_token(text,text,text,text,text,bigint,bigint,bytea,bytea,bytea,timestamptz),public.zasp_runtime_rotate_sensor_token(text,text,text,text,text,text,bigint,bigint,bytea,bytea,bytea,timestamptz),public.zasp_runtime_revoke_sensor_token(text,text,text,text,text) TO zasp_discovery_api;
...
CREATE FUNCTION public.zasp_runtime_data_plane_security_ready() RETURNS boolean LANGUAGE sql STABLE SECURITY DEFINER SET search_path TO pg_catalog, public AS $$
 SELECT
  ...
  AND NOT has_function_privilege('zasp_runtime_ingest','zasp_discovery_sensor_heartbeat(text,text,text,text,bigint,text,bigint,jsonb)','EXECUTE')
	  AND has_function_privilege('zasp_discovery_api','zasp_runtime_issue_sensor_token(text,text,text,text,text,bigint,bigint,bytea,bytea,bytea,timestamptz)','EXECUTE')
...
INSERT INTO public.zasp_schema_metadata(key,value) VALUES('runtime_data_plane_fingerprint', 'b8be27208fce2e60ba0f9f9541aaefaaf37a458dd6ce6ceda99fffdc24fa3f95');
...
GRANT EXECUTE ON FUNCTION public.zasp_runtime_data_plane_readiness(text,text) TO zasp_discovery_api,zasp_runtime_ingest,zasp_runtime_coordinator,zasp_runtime_archive_worker,zasp_runtime_index_worker,zasp_runtime_correlation_worker,zasp_runtime_projection_worker,zasp_gateway_control;
