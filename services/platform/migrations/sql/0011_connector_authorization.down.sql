...
BEGIN
  ...
  IF actual_fingerprint<>'1e5c5286dd32e9514be275d3b7ef54dfc479f6772f264c2b45da9c066cb80fb9' THEN RAISE EXCEPTION USING ERRCODE='55000',MESSAGE='semantic schema drift blocks rollback'; END IF;
END $rollback_guard$;
