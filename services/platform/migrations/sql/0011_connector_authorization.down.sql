...
BEGIN
  ...
  IF actual_fingerprint<>'2626f2629c086e7b53484cb3cfa66d64cfe00fb83f004df841ad2bf88eedebfc' THEN RAISE EXCEPTION USING ERRCODE='55000',MESSAGE='semantic schema drift blocks rollback'; END IF;
END $rollback_guard$;
...
DROP FUNCTION zasp_connector_recover_final_attempts(text,integer,integer);
