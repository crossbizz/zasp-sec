...
BEGIN
  ...
  IF actual_fingerprint<>'10c194e0172ae1ba7f81a3f99a26bd2f111d08baa865184c6e04a0bf9410dc98' THEN RAISE EXCEPTION USING ERRCODE='55000',MESSAGE='semantic schema drift blocks rollback'; END IF;
END $rollback_guard$;
