...
BEGIN
  ...
  IF actual_fingerprint<>'aebbc75ed6eda968c7a20f5d8f2b8acab7ba7698b57ef66c81c67b8fdda5ff95' THEN RAISE EXCEPTION USING ERRCODE='55000',MESSAGE='semantic schema drift blocks rollback'; END IF;
END $rollback_guard$;
