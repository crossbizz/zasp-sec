...
BEGIN
  ...
  IF actual_fingerprint<>'b61bb540fba6456fb64680b8b91fc3221133cf748de3f0365478c9c2f385c38f' THEN RAISE EXCEPTION USING ERRCODE='55000',MESSAGE='semantic schema drift blocks rollback'; END IF;
END $rollback_guard$;
