...
BEGIN
  ...
  IF actual_fingerprint<>'a59ef98ba1ffdcca3996cbf4d95fcd83c204dabf6f12457d90387acbe93e5b38' THEN RAISE EXCEPTION USING ERRCODE='55000',MESSAGE='semantic schema drift blocks rollback'; END IF;
END $rollback_guard$;
