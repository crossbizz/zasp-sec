...
BEGIN
    ...
    IF actual_fingerprint<>'35bbafb29b403b71eafa01dd331eb1785de209efd352eca455ffeed1ac43fad3' THEN RAISE EXCEPTION USING ERRCODE='55000',MESSAGE='semantic schema drift blocks rollback'; END IF;
END;
$rollback_guard$;
