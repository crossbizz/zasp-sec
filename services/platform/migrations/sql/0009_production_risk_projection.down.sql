...
BEGIN
    ...
    IF actual_fingerprint<>'ae8c0dcb0fdae3bfa854c2a0c1ea412d8582453073fad8db496e019831553972' THEN RAISE EXCEPTION USING ERRCODE='55000',MESSAGE='semantic schema drift blocks rollback'; END IF;
END;
$rollback_guard$;
