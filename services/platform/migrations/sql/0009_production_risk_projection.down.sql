...
BEGIN
    ...
    IF actual_fingerprint<>'1f75d1a9271ef19ae2a7c9525f9382f31f37f922ae2a058993705fe11ec373d2' THEN RAISE EXCEPTION USING ERRCODE='55000',MESSAGE='semantic schema drift blocks rollback'; END IF;
END;
$rollback_guard$;
