...
INSERT INTO public.zasp_schema_metadata(key,value) VALUES('red_team_execution_fingerprint', 'b231ad62d94f862bbd93b3fe12ac6a38781322db5bfd68381c7ca19b79ca2d9e') ON CONFLICT(key) DO UPDATE SET value=excluded.value;
