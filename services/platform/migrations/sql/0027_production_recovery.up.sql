...
BEGIN
 FOREACH function_value IN ARRAY ARRAY[
  ...
  'public.zasp_recovery_claim_operation(text,text,bytea,integer,integer)'::regprocedure,'public.zasp_recovery_heartbeat_operation(text,text,text,text,text,text,bytea,integer)'::regprocedure,'public.zasp_recovery_begin_hold(text,text,text,text,text,bytea)'::regprocedure,'public.zasp_recovery_release_hold(text,text,text,text,text,bytea)'::regprocedure,'public.zasp_recovery_capture_page(text,text,text,text,text,bytea,text,text,integer)'::regprocedure,'public.zasp_recovery_validate_scope(text,text,text)'::regprocedure,'public.zasp_recovery_projection_page(text,text,text,text,text,text,integer)'::regprocedure,
...
INSERT INTO public.zasp_schema_metadata(key,value) VALUES('production_recovery_fingerprint', 'c4ed612fc17e6ae209bdad9ca9145cb469daea0af4afbc2aa72f7618115505a8') ON CONFLICT(key) DO UPDATE SET value=excluded.value;
