...
BEGIN
 IF NOT EXISTS(SELECT 1 FROM public.zasp_schema_metadata WHERE key='production_core_schema' AND value='production-recovery-v1') OR EXISTS(SELECT 1 FROM public.zasp_schema_versions WHERE version>27)
  OR NOT EXISTS(SELECT 1 FROM public.zasp_schema_metadata WHERE key='production_recovery_fingerprint' AND value='c4ed612fc17e6ae209bdad9ca9145cb469daea0af4afbc2aa72f7618115505a8')
  OR NOT public.zasp_recovery_execution_security_ready() OR public.zasp_recovery_execution_live_fingerprint()<>'c4ed612fc17e6ae209bdad9ca9145cb469daea0af4afbc2aa72f7618115505a8'
...
DROP FUNCTION public.zasp_recovery_fail_operation(text,text,text,text,text,text,bytea,text,integer,jsonb);DROP FUNCTION public.zasp_recovery_finish_restore(text,text,text,text,text,bytea,jsonb,jsonb,jsonb);DROP FUNCTION public.zasp_recovery_checkpoint_restore(text,text,text,text,text,bytea,text,text,jsonb);DROP FUNCTION public.zasp_recovery_finish_backup(text,text,text,text,text,bytea,jsonb);DROP FUNCTION public.zasp_recovery_projection_page(text,text,text,text,text,text,integer);DROP FUNCTION public.zasp_recovery_validate_scope(text,text,text);DROP FUNCTION public.zasp_recovery_capture_page(text,text,text,text,text,bytea,text,text,integer);DROP FUNCTION public.zasp_recovery_release_hold(text,text,text,text,text,bytea);DROP FUNCTION public.zasp_recovery_begin_hold(text,text,text,text,text,bytea);DROP FUNCTION public.zasp_recovery_heartbeat_operation(text,text,text,text,text,text,bytea,integer);DROP FUNCTION public.zasp_recovery_claim_operation(text,text,bytea,integer,integer);
