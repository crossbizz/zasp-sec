DO $release_guard$ BEGIN
 IF NOT zasp_runtime_data_plane_readiness(
  '418a8aaaf9fa74ecda7686019ab977cf64ccbf52936c8f8463745a10a3335fea',
  '33527c1e1472b8ebfee11c93c992e4ec8f3e8c6a17806bb94ea353a19ef349c5'
...
CREATE FUNCTION public.zasp_runtime_gateway_reconciliation_readiness(expected_checksum text,expected_fingerprint text) RETURNS boolean LANGUAGE sql STABLE SECURITY DEFINER SET search_path TO pg_catalog, public AS $$
 SELECT length(expected_checksum)=64 AND length(expected_fingerprint)=64
  ...
  AND EXISTS(SELECT 1 FROM zasp_schema_versions release WHERE (release.version,release.name,release.checksum)=(15,'runtime_data_plane','418a8aaaf9fa74ecda7686019ab977cf64ccbf52936c8f8463745a10a3335fea'))
...
INSERT INTO public.zasp_schema_metadata(key,value) VALUES('runtime_gateway_reconciliation_fingerprint', '39b7ed08ebe142003b931feeb502ed8fd500b332679733a7305cb8bbd14f9556');
