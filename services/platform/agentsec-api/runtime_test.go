...
func TestLoadRuntimeConfigIsStrict(t *testing.T) {
	values := map[string]string{
		...
		"ZASP_STYTCH_BASE_URL":             "https://api.stytch.com", "ZASP_STYTCH_AUTHORIZE_URL": "https://api.stytch.com/v1/b2b/public/oauth/google/start", "ZASP_STYTCH_PROJECT_ID": "project-live-local", "ZASP_STYTCH_SECRET": "secret-live-local", "ZASP_STYTCH_WEBHOOK_SECRET": "whsec_MTExMTExMTExMTExMTExMTExMTExMTExMTExMTExMTE=", "ZASP_STYTCH_PUBLIC_TOKEN": "public-token-live-local", "ZASP_STYTCH_ORGANIZATION_ID": "organization-live-local", "ZASP_WORKFLOW_SIGNING_KEY": "0123456789abcdef0123456789abcdef", "ZASP_TOKEN_REVEAL_KEY": "MDEyMzQ1Njc4OWFiY2RlZjAxMjM0NTY3ODlhYmNkZWY",
		...
		"ZASP_POLICY_HISTORY_ENDPOINT": "https://vpc-zasp.us-east-1.es.amazonaws.com", "ZASP_POLICY_HISTORY_INDEX": "zasp-runtime-events-v1",
	...
	invalidTicketCIDRs := mapsClone(values)
	invalidTicketCIDRs["ZASP_FINDING_TICKET_EGRESS_CIDRS"] = "0.0.0.0/0"
	if _, err := loadRuntimeConfig(func(key string) string { return invalidTicketCIDRs[key] }); !errors.Is(err, errInvalidRuntimeConfig) {
		t.Fatalf("invalid ticket egress CIDRs error = %v", err)
	}

	for _, key := range []string{"ZASP_ENVIRONMENT", "ZASP_PRODUCT_LISTEN_ADDRESS", "ZASP_INTERNAL_LISTEN_ADDRESS", "ZASP_PUBLIC_ORIGIN", "ZASP_COOKIE_SECURE", "ZASP_TRUSTED_PROXY_CIDRS", "ZASP_REQUEST_RATE_PER_SECOND", "ZASP_REQUEST_BURST", "ZASP_PROVIDER_TIMEOUT", "ZASP_REQUEST_TIMEOUT", "ZASP_SHUTDOWN_TIMEOUT", "ZASP_READINESS_INTERVAL", "ZASP_READINESS_MAX_INTERVAL", "ZASP_DISCOVERY_PARSER_VERSION", "ZASP_DISCOVERY_TOOL_VERSION", "ZASP_DEPLOYMENT_MODE", "ZASP_POSTGRES_DSN", "ZASP_SECURITY_AGENT_POSTGRES_DSN", "ZASP_STYTCH_BASE_URL", "ZASP_STYTCH_AUTHORIZE_URL", "ZASP_STYTCH_PROJECT_ID", "ZASP_STYTCH_SECRET", "ZASP_STYTCH_WEBHOOK_SECRET", "ZASP_STYTCH_PUBLIC_TOKEN", "ZASP_STYTCH_ORGANIZATION_ID", "ZASP_WORKFLOW_SIGNING_KEY", "ZASP_TOKEN_REVEAL_KEY", "ZASP_CONNECTOR_AWS_REGION", "ZASP_CONNECTOR_ROLE_ARN", "ZASP_CONNECTOR_WEB_IDENTITY_TOKEN_FILE", "ZASP_CONNECTOR_KMS_KEY_ARN", "ZASP_CONNECTOR_SECRET_PREFIX", "ZASP_POLICY_HISTORY_ENDPOINT", "ZASP_POLICY_HISTORY_INDEX", "ZASP_AWS_CUSTOMER_ROLE_PREFIXES", "ZASP_AWS_CUSTOMER_ROLE_ARNS", "ZASP_FINDING_TICKET_EGRESS_CIDRS", "ZASP_GITHUB_CLIENT_ID", "ZASP_GITHUB_CLIENT_SECRET_REFERENCE", "ZASP_GITHUB_APP_ID", "ZASP_GITHUB_PRIVATE_KEY_REFERENCE", "ZASP_OKTA_CLIENT_ID", "ZASP_OKTA_CLIENT_SECRET_REFERENCE"} {
