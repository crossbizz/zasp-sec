...
func TestLoadRuntimeConfigIsStrict(t *testing.T) {
	values := map[string]string{
		...
		"ZASP_AWS_CUSTOMER_ROLE_PREFIX": "arn:aws:iam::123456789012:role/zasp/", "ZASP_KUBERNETES_EGRESS_CIDRS": "203.0.113.0/24",
