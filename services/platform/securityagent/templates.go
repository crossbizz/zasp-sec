...
func BuiltInTemplates() []Template {
	return []Template{
		...
		{ID: "temporary_policy_containment", Name: "Temporary Policy Containment", Version: 1, TriggerKind: "finding", DefaultActions: []string{"create_temporary_policy"}, VerificationCondition: "policy_state", ApprovalRequired: map[string]bool{"create_temporary_policy": true}},
