...
func TestBootstrapMapsWorkflowManagementWithoutProviderOnlyCapabilities(t *testing.T) {
	...
	want := []string{"inventory.read", "scope.switch", "policies.read", "integrations.read", "sensors.read", "security-agents.read", "findings.read", "attack-paths.read", "administration.read", "system.read", "inventory.write", "policies.write", "integrations.write", "sensors.write", "security-agents.write"}
