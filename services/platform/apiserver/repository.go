...
const postgresRuntimeDataPlaneReadinessSQL = `SELECT to_jsonb(zasp_runtime_gateway_reconciliation_readiness($1,$2))`
...
func exactProductReadiness(version string) (string, string, string, bool) {
	...
	case RuntimeDataPlaneSchemaVersion:
		return postgresRuntimeDataPlaneReadinessSQL, migrations.ProductionRuntimeGatewayReconciliation().Checksum(), migrations.ProductionRuntimeGatewayReconciliationSemanticFingerprint(), true
	default:
		return "", "", "", false
	}
}
