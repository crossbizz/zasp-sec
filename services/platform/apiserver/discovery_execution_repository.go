...
func discoveryExecutionReady(ctx context.Context, database JSONDatabase) bool {
	...
	var ready bool
	for _, version := range []string{SecurityAgentExecutionSchemaVersion, RuntimeIngestReconciliationSchemaVersion, RuntimeGatewayReconciliationSchemaVersion, RuntimeDataPlaneSchemaVersion, TypedInventorySchemaVersion, DiscoveryExecutionSchemaVersion} {
