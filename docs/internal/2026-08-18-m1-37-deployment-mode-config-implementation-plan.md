...
- [x] **Step 3: Move only M1-37 to In progress**
...
- [x] **Step 1: Capture missing deployment API RED**
...
- [x] **Step 2: Implement the minimal valid modes and accessors**
...
- [x] **Step 3: Add hostile matrix RED/GREEN**
...
- [x] **Step 1: Audit source and value integrity**
...
- [x] **Step 2: Audit mode/pin combinations and scope**
...
- [x] **Step 2: Transition only M1-37 to Complete**
