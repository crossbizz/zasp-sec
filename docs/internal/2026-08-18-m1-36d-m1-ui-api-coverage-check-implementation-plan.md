...
- [ ] **Step 3: Move only M1-36d to In progress**
...
- [ ] **Step 1: Establish the exact input and command baseline**
...
- [ ] **Step 2: Run the hostile validator suite**
...
- [ ] **Step 3: Run six consecutive real checks**
...
- [ ] **Step 4: Re-prove traceability scope**
...
- [ ] **Step 2: Transition only M1-36d to Complete**
