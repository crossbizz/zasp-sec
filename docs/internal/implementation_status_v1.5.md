...
session configuration. The 728 source-plan counts are `676/1/48/3` because
...
| --- | --- | --- |
| M1-19 | August 16, 2026 | Defining a product-owned scoped ProductTelemetry boundary whose closed allowlist serializer rejects every unknown field before one bounded fake-driver capture. |
