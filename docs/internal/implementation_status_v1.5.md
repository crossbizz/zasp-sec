...
session configuration. The 728 source-plan counts are `686/1/38/3` because
...
| --- | --- | --- |
| M1-09 | August 15, 2026 | Implement the scoped atomic idempotency claim/completion interface and prior-result request helper. |
