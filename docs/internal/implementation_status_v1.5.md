...
session configuration. The 728 source-plan counts are `668/1/56/3` because
...
| --- | --- | --- |
| M1-27 | August 16, 2026 | Adding a frontend ESLint rule and seeded hostile tests that forbid raw Fetch calls outside the exact generated-client boundary. |
