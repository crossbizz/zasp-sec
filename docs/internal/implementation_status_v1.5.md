...
session configuration. The 728 source-plan counts are `647/1/77/3` because
...
| --- | --- | --- |
| M1-36e | August 18, 2026 | Running the reviewed disposable assembled Kubernetes and LocalStack smoke with exact pre/post absence and shared-state non-interference evidence. |
