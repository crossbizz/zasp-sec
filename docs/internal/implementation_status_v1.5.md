...
session configuration. The 728 source-plan counts are `664/1/60/3` because
...
| --- | --- | --- |
| M1-28d | August 16, 2026 | Wire the reviewed shared health handler into the runtime-gateway command with exact liveness/readiness smoke coverage, bounded lifecycle behavior, and a closed repository-owned dependency edge. |
