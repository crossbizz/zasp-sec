...
session configuration. The 728 source-plan counts are `645/1/79/3` because
...
| --- | --- | --- |
| M1-38 | August 18, 2026 | Add a stateless repository guard that rejects missing or malformed product Organization scope before SQL execution and prepends the trusted canonical ID as query argument zero. |
