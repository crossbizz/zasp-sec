...
- [x] **Step 3: Move only M1-35 to In progress**
...
- [x] **Step 1: Write exact navigation RED**
...
- [x] **Step 2: Write route-guard compiler RED**
...
- [x] **Step 3: Implement the minimal readonly route catalog**
...
- [x] **Step 4: Implement the pure fail-closed guard resolver**
...
- [x] **Step 5: Run focused stability and commit**
...
- [x] **Step 1: Write rendered left-nav RED**
...
- [x] **Step 2: Write guard component RED**
...
- [x] **Step 3: Extract `LeftNav` and preserve `AppShell`**
...
- [x] **Step 4: Implement the inert guard component**
...
- [x] **Step 5: Preserve working demo smoke paths**
...
- [x] **Step 6: Run focused stability and commit**
...
- [x] **Step 2: Add wiring and documentation GREEN**
...
- [x] **Step 3: Scan and commit the wiring slice**
...
- [x] **Step 4: Transition only M1-35 to Complete**
...
- [x] **Step 5: Push and require exact-SHA Runnable UI success**
...
- [x] **Step 6: Close the plan and verify closure**
