...
- [x] **Step 3: Move only M1-36e to In progress**
...
- [x] **Step 1: Establish the exact clean assembly baseline**
...
- [x] **Step 2: Run hostile and inherited hermetic suites**
...
- [x] **Step 3: Run six consecutive focused assembly checks**
...
- [x] **Step 4: Capture the independent live preflight**
...
- [x] **Step 1: Run one exact env-isolated live command**
...
- [x] **Step 2: Prove exact post-live absence and non-interference**
...
- [x] **Step 3: Run the full local verification matrix and review**
...
- [x] **Step 2: Transition only M1-36e to Complete**
