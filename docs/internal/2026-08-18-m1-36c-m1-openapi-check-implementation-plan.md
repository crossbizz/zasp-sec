...
- [ ] **Step 3: Move only M1-36c to In progress**
...
- [ ] **Step 1: Establish the exact clean input/output baseline**
...
- [ ] **Step 2: Run the supported writer and prove no diff**
...
- [ ] **Step 3: Run strict validation and six drift checks**
...
- [ ] **Step 4: Re-prove hostile drift behavior and scope**
...
- [ ] **Step 2: Transition only M1-36c to Complete**
