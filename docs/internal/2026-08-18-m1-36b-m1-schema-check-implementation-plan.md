...
- [x] **Step 3: Move only M1-36b to In progress**
...
- [x] **Step 1: Write behavior-first runner RED**
...
- [x] **Step 2: Implement the minimal five-target runner**
...
- [x] **Step 3: Add hostile result and environment coverage**
...
- [x] **Step 4: Run six focused passes and the real root gate**
...
- [x] **Step 2: Transition only M1-36b to Complete**
