...
- [ ] **Step 3: Move only M1-36a to In progress**
...
- [ ] **Step 1: Re-prove the hermetic orchestrator contract**
...
- [ ] **Step 2: Create one exact detached clean checkout**
...
- [ ] **Step 3: Install only locked web dependencies**
...
- [ ] **Step 4: Run the exact eight-target build**
...
- [ ] **Step 5: Prove source stability and remove evidence artifacts**
...
- [ ] **Step 2: Transition only M1-36a to Complete**
